...
public class TestHanZiLength {
	...
	public void getHanZiUnicode(){
		...
		System.out.println(util.decodeWithSeparator(string, UnicodeUtils.SeparatorMode.UNICODEMODE.getMode()));
		...
		String count[] =util.hanZiToHex("你好，很高兴见到你！！！ Hello",UnicodeUtils.SeparatorMode.UNICODEMODE);
		System.out.println(count[0]);
		System.out.println(util.decodeWithSeparator(count[0], count[1]));
		
		String[] encodeString=util.encodeWithSeparator("你好，很高兴见到你！！！ Hello", UnicodeUtils.SeparatorMode.STANDLINE);
		System.out.println("encodeString[0]:"+encodeString[0]);
		System.out.println("encodeWithoutSeparator:"+ util.encodeWithOutSeparator("你好，很高兴见到你！！！")[2]);
		System.out.println(util.decodeWithSeparator(encodeString[0],encodeString[1]));
		System.out.println(util.decodeFilterChineseWithOutSepa(util.encodeWithOutSeparator("你好，很高兴见到你！！！Hello, nice to meet you !")));
		System.out.println(util.decode(util.decodeWithOutSeparator(util.encodeWithOutSeparator("你好，很高兴见到你！！！"))));
	}
	...
	@Test public void testFileChinese(){
		String fileter="65";
